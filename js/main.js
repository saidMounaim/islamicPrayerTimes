...
function mousemove(d, i) {
    ...
    if (mapDataSet[Math.floor(xo)]) {
      ...
      focusDate.select("text").style('fill', '#BBBBBB').text(xx);
      focusFajr.select("text").style('fill', '#BBBBBB').text("Fajr " + stringFajr);
      focusSunrise.select("text").style('fill', '#BBBBBB').text("Sunrise " + stringSunrise);  
      focusDhuhr.select("text").style('fill', '#BBBBBB').text("Dhuhr " + stringDhuhr);  
      focusAsr.select("text").style('fill', '#BBBBBB').text("Asr " + stringAsr);  
      focusMaghrib.select("text").style('fill', '#BBBBBB').text("Maghrib " + stringMaghrib);  
      focusIsha.select("text").style('fill', '#BBBBBB').text("Isha " + stringIsha); 
